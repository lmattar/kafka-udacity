...
def topic_exists(client, topic_name):
    ...
    #difiere del video.pero es mas elegante esta forma
...
def create_topic(client, topic_name):
    ...
    # crea un elemento en la lista de topics que recibe el metodo
    #podria crearlos afuera con un for si necesitara mas topicos
...
def main():
    ...
    #
    topic_name = "topico-ejercicio2.1"
